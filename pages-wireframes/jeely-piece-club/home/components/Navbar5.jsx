    ...
    >
      <div className="size-full lg:flex lg:items-center lg:justify-between">
                    ...
                    <div className="grid flex-1 gap-x-8 gap-y-6 py-4 pr-8 md:grid-cols-2 md:px-0 md:py-8 lg:py-8 lg:pr-8">
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Support Us</h5>
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Get in touch with Jeely Piece Club
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Book</h5>
                            <p className="hidden text-sm md:block">
                              Reserve your spot at an activity
                            </p>
                          </div>
                        </a>
                      </div>
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Safeguarding</h5>
                            <p className="hidden text-sm md:block">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Annual Reports</h5>
                            <p className="hidden text-sm md:block">
                              See how we've grown and served
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Governance</h5>
                            <p className="hidden text-sm md:block">
                              How we're run and who leads us
                            </p>
                          </div>
                        </a>
                      </div>
        ...
        <div className="hidden lg:flex lg:gap-4">
          <Button title="Donate" variant="secondary" size="sm">
            Donate
          </Button>
